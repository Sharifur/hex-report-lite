...
export default function ByProductType(){
    ...
    const TableData = [
        ["Singapore","63164.00","10.616.00","24.29.00","606.775.00","8.7268.00","37.546.00","654.433.00"],
        ["Malaysia","2620312","60.000","124.000","573.750.00","2.756.000","67.660.75","210.000.75"]
    ];


    return (
        <PageLayout pageTitle="Sales By Locations">
            <Card padd="0">
                <PageHeader pageTitle="Sales By Locations" extraClass="padding-20 padding-bottom-0"/>
